    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='Номер телефона учащегося')),
                ('sex', models.CharField(blank=True, choices=[('M', 'М'), ('F', 'Ж')], max_length=1, null=True, verbose_name='Пол')),
                ...
                ('image_profile', models.ImageField(blank=True, upload_to='profiles/', verbose_name='Аватар')),
